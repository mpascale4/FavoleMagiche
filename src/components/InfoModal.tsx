      ...
      <div className="bg-[#110D26] text-slate-100 rounded-[1.5rem] border-3 border-[#EC407A]/50 shadow-[0_20px_60px_rgba(0,0,0,0.45)] w-full max-h-[96%] overflow-hidden flex flex-col">
        <div className="bg-[#1a1438] border-b border-slate-700/60 p-4 flex items-start justify-between gap-4">
          <div className="flex items-start gap-3 flex-1">
            <div className="w-11 h-11 bg-[#EC407A] rounded-xl flex items-center justify-center text-white text-xl shrink-0">✨</div>
          ...
          <div className="w-full bg-[#0d0a1f] text-slate-100 rounded-2xl p-3 shadow-md text-left font-mono text-[10px] border-2 border-[#EC407A]/40">
            ...
            <div className="space-y-1.5 mt-3">
              ...
              <div className="space-y-2 max-h-56 overflow-y-auto scrollbar-none">
                {history.length === 0 && (
                  <div className="rounded-lg border border-slate-700 p-2 bg-[#1a1438] text-slate-400">
                    Nessuno storico versioni disponibile.
                  </div>
                )}

                {history.map((entry) => (
                  <div key={entry.version} className="rounded-lg border border-slate-700 p-2 bg-[#1a1438]">
