---
applyTo: "**/*.tsx,**/*.ts"
description: "Convenzioni React/TypeScript per favole-magiche (React 19 + Vite + Tailwind)"
---

# Istruzioni React/TypeScript – favole-magiche
...
- Test: Vitest + React Testing Library sono già presenti nel progetto
  (`npm run test`); coprire logica critica (generazione storie, achievement,
  riduttori di stato complessi) con happy path + edge case.
